...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            // Obtener la imagen de perfil del usuario usando canvacord
            const card = new RankCardBuilder();
            card.setAvatar(user.displayAvatarURL({ format: 'png', size: 1024 }))
            card.setDisplayName('Kiki')
